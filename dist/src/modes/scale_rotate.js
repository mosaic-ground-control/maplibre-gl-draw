 ...
 */
export class SRMode extends ModeBase {
    constructor() {
        super(...arguments);
        this.isRotatePoint = CommonSelectors.isOfMetaType(Constants.meta.MIDPOINT);
        this.isVertex = CommonSelectors.isOfMetaType(Constants.meta.VERTEX);
        this.TxMode = {
            Scale: 1,
            Rotate: 2,
        };
    ...
    onVertex(state, e) {
        ...
        state.txMode = this.TxMode.Scale;
    }
    ;
    onRotatePoint(state, e) {
        ...
        const about = e.featureTarget.properties;
        state.selectedCoordPaths = [about.coord_path];
        state.txMode = this.TxMode.Rotate;
    }
    ;
    onFeature(state, e) {
    ...
    onDrag(state, e) {
        ...
        if (state.selectedCoordPaths.length > 0 && state.txMode) {
            switch (state.txMode) {
                case this.TxMode.Rotate:
                    this.dragRotatePoint(state, e, delta);
                    break;
                case this.TxMode.Scale:
...
//# sourceMappingURL=scale_rotate.js.map